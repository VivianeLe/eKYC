...
def polygon_from_corners(t):
    t0 = t[t[:, 0] == 0]  # top-left points
    t1 = t[t[:, 0] == 1]  # top-right points
    t2 = t[t[:, 0] == 2]  # bottom-right points
    t3 = t[t[:, 0] == 3]  # bottom-left points
    ...
    backup_point = np.array([0, 0, 0, 0, 0, 0])
